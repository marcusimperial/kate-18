...
const Inform = ({ clicked, updateClicked }) => {
    ...
    return (
        <div className="grid items-center justify-items-center p-3 gap-4">
            <h1 data-aos="fade-in" data-aos-delay="200" className="text-8xl md:text-9xl font-elegante text-purpureus text-center">{ clicked?.success ? "You're All Set!" : "That's Not Registered!"}</h1>
